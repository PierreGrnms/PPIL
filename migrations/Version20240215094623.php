 ...
 */
final class Version20240215094623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__utilisateur AS SELECT id, inscription_annuelle_id, id_user, roles, password, nom, prenom, adresse_mail, nom_de_la_rue, numero, code_postal, numero_telephone, porte_monnaie, code_de_carte_bancaire FROM utilisateur');
        $this->addSql('DROP TABLE utilisateur');
        $this->addSql('CREATE TABLE utilisateur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, inscription_annuelle_id INTEGER DEFAULT NULL, id_user VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        ...
        $this->addSql('INSERT INTO utilisateur (id, inscription_annuelle_id, id_user, roles, password, nom, prenom, adresse_mail, nom_de_la_rue, numero, code_postal, numero_telephone, porte_monnaie, code_de_carte_bancaire) SELECT id, inscription_annuelle_id, id_user, roles, password, nom, prenom, adresse_mail, nom_de_la_rue, numero, code_postal, numero_telephone, porte_monnaie, code_de_carte_bancaire FROM __temp__utilisateur');
