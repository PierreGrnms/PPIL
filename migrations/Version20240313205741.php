 ...
 */
final class Version20240313205741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE disponibilites (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_offre_id INTEGER NOT NULL, debut DATETIME NOT NULL, fin DATETIME NOT NULL, CONSTRAINT FK_B0F3489C1C13BCCF FOREIGN KEY (id_offre_id) REFERENCES offre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE offre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_user_id INTEGER DEFAULT NULL, titre_offre VARCHAR(255) NOT NULL, texte_offre VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, CONSTRAINT FK_AF86866F79F37AE5 FOREIGN KEY (id_user_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_AF86866F79F37AE5 ON offre (id_user_id)');
        $this->addSql('CREATE TABLE photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_offre_id INTEGER NOT NULL, nom VARCHAR(255) NOT NULL, CONSTRAINT FK_14B784181C13BCCF FOREIGN KEY (id_offre_id) REFERENCES offre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_user_id INTEGER NOT NULL, id_offre_id INTEGER NOT NULL, reserv_debut DATETIME NOT NULL, reserv_fin DATETIME NOT NULL, CONSTRAINT FK_42C8495579F37AE5 FOREIGN KEY (id_user_id) REFERENCES utilisateur (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_42C849551C13BCCF FOREIGN KEY (id_offre_id) REFERENCES offre (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
